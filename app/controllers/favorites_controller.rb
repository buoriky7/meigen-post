class FavoritesController < ApplicationController
  def index
    @user = current_user
    @favorite = @user.favorites.page(params[:page]).per(50).reverse_order
    @favorites = @user.favorites.all
  end

# https://qiita.com/tomoharutsutsumi/items/488beb4983b12484bbb6
  ...
  def rank_all
    ...
    @word_ranking = Word.where(id: word_favorited_ids).sort_by{|o| word_favorited_ids.index(o.id)}[0..19]
  end
